...
4. **Payment Webhook Response:** Lastly, you need to be familiar with the [Payment Webhook response](webhooks/payment-notification.md). This response is returned by the Auto Debit API, providing important information about the transaction status.
...
* **Merchant Receives Notification:** Once the payment is made, your [webhook\_url](webhooks/payment-notification.md) gets notified about the payment. You can then save the card details in your database for future transactions.
