...
For uploading the [“Apple Pay Payment processing certificate”](apple-pay.md#download-the-file-which-is-the-apple-pay-payment-processing-certificate-file), follow the instructions provided in the figure below under “step 6”.
