...
*   To generate the advance payment request, merchants should select the necessary invoices. <br>
...
*   If the merchant checks the Manual Payment box, they will proceed with the selected advance payment using the same process as manual payment. For more information, please refer to the [Manual Payment](manual-payment.md) section.<br>
